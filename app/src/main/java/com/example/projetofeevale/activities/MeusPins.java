...
import com.example.projetofeevale.databinding.MeuspinsBinding;

/**
 * An example full-screen activity that shows and hides the system UI (i.e.
 * status bar and navigation/system bar) with user interaction.
 */
public class MeusPins extends AppCompatActivity {

    private MeuspinsBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = MeuspinsBinding.inflate(getLayoutInflater());
